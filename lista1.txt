...
#16 - Verifique qual dos valores do Brasil é positivo. E quais são negativos. Atribua os dois resultados a um objeto. 

#17 - Descubra quais meses são "TRUE" em cada uma das variáveis criadas no exercício anterior. 

#18 - Inverta o vetor EUA. O que aconteceu com a variável original? Foi alterada?
...
#20 - Adicione os valores das somas de cada país no final de cada vetor. 
